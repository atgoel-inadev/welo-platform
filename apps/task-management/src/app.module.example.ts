/**
 * Example: Task Management Service - Updated to use Messaging Abstraction
 * 
 * This demonstrates how to migrate from KafkaModule to MessagingModule
 * for environment-aware messaging (Kafka or AWS SNS/SQS)
 */
...
// ── UPDATED: Use MessagingModule instead of KafkaModule ────────────────────
...
@Module({
  imports: [
    ...
    // ── UPDATED: Environment-aware messaging configuration ────────────────────
    MessagingModule.forRootAsync({
      useFactory: (configService: ConfigService): MessagingConfig => {
        ...
        return {
          ...
          // Kafka configuration (used when MESSAGING_PROVIDER=kafka)
          kafka: {
          ...
          // AWS SNS/SQS configuration (used when MESSAGING_PROVIDER=aws)
          aws: {
